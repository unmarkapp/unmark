...
export const SITE_TAGLINE =
  "Unmark cleans AI media: remove Gemini sparkles from images and videos. Free Instant image cleanup in your browser — Cloud for video, Library, bulk, and the Chrome extension.";
